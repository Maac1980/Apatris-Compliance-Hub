                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 text-xs text-muted-foreground">
                    <div className="flex items-center gap-1">
                      ...
                      <span>{site.professionals} deployed</span>
                    </div>
                    <div className="flex items-center gap-1">
                    ...
                    {site.professionals - site.compliant > 0 && (
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-red-600 font-medium">{site.professionals - site.compliant} issues</span>
                      </div>
                    )}
                  </div>
                </div>
      ...
      <div className="bg-white rounded-2xl border shadow-sm overflow-hidden">
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 h-36 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-xs text-blue-400">Deployment visualization — Phase 4</p>
          </div>
        </div>
      </div>
    </motion.div>
