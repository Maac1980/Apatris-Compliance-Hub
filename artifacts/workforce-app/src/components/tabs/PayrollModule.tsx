  ...
  return (
    ...
    >
      <div className="flex items-center justify-between ml-1">
        <h2 className="text-[10px] font-heading font-bold uppercase tracking-widest text-muted-foreground">ZUS & Payroll Ledger</h2>
      ...
      <div className="space-y-3">
        <h3 className="text-[10px] font-heading font-bold uppercase tracking-widest text-muted-foreground ml-1">Umowa Zlecenie · Breakdown</h3>
      ...
      {/* Quick actions */}
      <div className="space-y-3">
        <h3 className="text-[10px] font-heading font-bold uppercase tracking-widest text-muted-foreground ml-1">Actions</h3>
        <div className="grid grid-cols-2 gap-3">
          {[
            { icon: Download, label: "Export CSV", sub: "Full payroll ledger", bg: "bg-indigo-500/10", col: "text-indigo-600", border: "hover:border-indigo-500/25" },
            { icon: Calculator, label: "ZUS Calculator", sub: "Manual entry", bg: "bg-blue-500/10", col: "text-blue-600", border: "hover:border-blue-500/25" },
            { icon: BookOpen, label: "Umowy Zlecenie", sub: "5 contracts active", bg: "bg-emerald-500/10", col: "text-emerald-600", border: "hover:border-emerald-500/25" },
            { icon: CreditCard, label: "B2B Contracts", sub: "2 active", bg: "bg-teal-500/10", col: "text-teal-600", border: "hover:border-teal-500/25" },
