...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { path: "/legal-immigration",   label: "Legal Immigration",  icon: Shield },
      ...
      { path: "/intelligence-dashboard", label: "Intelligence", icon: Shield },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/regulatory",          label: "Reg. Updates",  icon: Shield },
      { path: "/regulatory/sources", label: "Reg. Sources",  icon: Settings },
      { path: "/regulatory/review",  label: "Reg. Review",   icon: Shield },
      { path: "/regulatory/deployments", label: "Reg. Deploy", icon: Shield },
      { path: "/readiness",             label: "Readiness",    icon: BarChart3 },
