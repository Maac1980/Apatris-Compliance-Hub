...
export async function initializeDatabase(): Promise<void> {
  ...
  if (parseInt(ccCount[0]?.count ?? "0") < 7) {
    const countries = [
      { code: "PL", name: "Poland", cur: "PLN", minH: 31.40, minM: 4806, ssEmp: 13.71, ssEmpl: 20.48, tax: 12, pwd: "Posted from PL: A1 certificate required. Worker retains Polish ZUS. Minimum terms of host country apply after 12 months (extendable to 18).", notes: "Base country for Apatris. ZUS DRA filed monthly." },
