...
export interface AuditEntry {
  ...
  actor: string;
  actorEmail: string;
  action: "UPDATE_WORKER" | "CREATE_WORKER" | "UPLOAD_DOCUMENT" | "DELETE_WORKER" | "PAYROLL_COMMIT" | "ADMIN_LOGIN" | "SEND_NOTIFICATION" | "DOCUMENT_CHANGE" | "ADMIN_CREATE" | "ADMIN_UPDATE" | "ADMIN_DELETE" | "COORDINATOR_CREATE" | "COORDINATOR_UPDATE" | "COORDINATOR_DELETE" | "CONTRACT_CREATE" | "POA_CREATE" | "POA_DELETE" | "INVOICE_CREATE" | "INVOICE_UPDATE" | "INVOICE_SEND" | "INVOICE_DELETE" | "DOCUMENT_CREATE" | "DOCUMENT_UPDATE" | "DOCUMENT_DELETE" | "GDPR_EXPORT" | "DATA_EXPORT";
  workerId: string;
  workerName: string;
