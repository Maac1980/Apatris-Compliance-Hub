...
${config.legalArticles.join("\n")}`;
  ...
  // ── LIABILITY DISCLAIMER — auto-appended to every generated document ──
  const DISCLAIMER_PL = `\n\n---\nOŚWIADCZENIE: Niniejszy dokument został wygenerowany przez system Apatris Compliance Hub. Apatris Sp. z o.o. nie świadczy pomocy prawnej w rozumieniu Ustawy Prawo o adwokaturze ani Ustawy o radcach prawnych. Reprezentacja opiera się na art. 32-33 KPA i obejmuje wyłącznie czynności procesowe, nie poradę prawną. W celu uzyskania porady prawnej lub reprezentacji sądowej, pracownik powinien skonsultować się z licencjonowanym prawnikiem. Apatris nie ponosi odpowiedzialności za decyzje administracyjne.`;
  const DISCLAIMER_EN = `\n\n---\nDISCLAIMER: This document was generated by the Apatris Compliance Hub system. Apatris Sp. z o.o. does not provide legal assistance within the meaning of the Bar Act or Legal Advisors Act. Representation is based on Art. 32-33 KPA and covers procedural acts only, not legal advice. For legal advice or court representation, the worker should consult a licensed lawyer. Apatris is not liable for administrative decisions.`;

  contentPl += DISCLAIMER_PL;
  contentEn += DISCLAIMER_EN;
